...
getwd()
setwd('C:\\Users\\IT24104150\\Desktop\\IT24104150')
getwd()
...
##draw frequency olygon to the same plot
lines(mids,freq)
...
plot(breaks, new, type = 'l', main = "Cumlative Frequency Polygon for Shareholders", xlab = "Shareholders", ylab = "Cumlative Frequency", ylim = c(0,max(cum.freq)))

##obtain upper limit of each class along with its cumlative frequency in a table
cbind(Upper = breaks, CumFreq = new)
plot(breaks, new, type = 'o', main = "Cumlative Frequency Polygon for Shareholders", xlab = "Shareholders", ylab = "Cumlative Frequency", ylim = c(0,max(cum.freq)))
